		...
		if (horChegada >= 0 && horChegada <= 24 && minChegada >= 0 && minChegada <= 60 && horSaida >= 0 && horSaida <= 24
			...
			switch (qtdHoras) {
				...
				case 1: // 10,00
					precoCobrado = 10.00;
					break;
				case 2: // 10,00+15,00 = 25,00
					precoCobrado = 25.00;
					break;
				case 3: // 10,00+15,00+15,00 = 40,00
					precoCobrado = 40.00;
					break;
				case 4: // 10,00+15,00+15,00+20,00 = 60,00
					precoCobrado = 60.00;
					break;
				default: // 60,00 + (20 * (5 - 4))
					precoCobrado = 60.00 + (20.00 * (qtdHoras - 4));
					break;
			}
